...
var format = F.format;
var addEvent = U.addEvent, objectEach = U.objectEach, extend = U.extend, fireEvent = U.fireEvent, merge = U.merge, pick = U.pick, defined = U.defined;
...
var Breadcrumbs = /** @class */ (function () {
    function Breadcrumbs(chart, userOptions) {
        ...
        var chartOptions = merge(chart.options.drilldown &&
            chart.options.drilldown.drillUpButton, Breadcrumbs.defaultBreadcrumbsOptions, userOptions);
        this.chart = chart;
